...
<!--@param width_scale  位置  宽度比例 -->
<!--@param height_scale  位置  高度比列 -->
<#macro attach_scale_corp_disp attaches attachField attachDivId attachNum position readonly outWidth inlineWidth inlineHeigth width_scale height_scale>
<#if !readonly>
	<!-- 上传编辑  -->
		...
		<figure class="overlay" style="height:${inlineHeigth!150}px;width:${inlineWidth!150}px;">
			<figcaption class="overlay-panel overlay-background overlay-fade overlay-icon">
				<a class="icon wb-upload" style="margin: 0 5px; font-size: 1.286rem; width: 1.286rem" href="javascript:void(0)"
					onclick="uploadScaleCorpFile('${attachField}','${attachDivId}','${attachNum!1}','${position!}','${outWidth}','${inlineWidth}','${inlineHeigth}','${width_scale}','${height_scale}')"
					></a>
			</figcaption>
		</figure>
	</div>
    ...
    <#list attaches as attach>
    	<div style="padding:0 0 0.5rem 1.0715rem;width:${outWidth!150}px;height:auto" id="attachDiv_${attach.id}">
			<figure class="overlay overlay-hover" style="height:${inlineHeigth!150}px;width:${inlineWidth!150}px;">
				...
				<figcaption class="overlay-panel overlay-background overlay-fade overlay-icon">
					<a class="icon wb-search" style="margin:0 5px;font-size:1.286rem;width:1.286rem;" onclick="clickImg(event,this)" href="javascript:void(0)"></a>
					...
					<#if !readonly>
					<a class="icon wb-close" style="margin:0 5px;font-size:1.286rem;width:1.286rem" onclick="_removeScaleCorpAttach('${attach.id!}','${attachField}','${attachDivId}','${attachNum!1}','${position!}'
					,'${outWidth}','${inlineWidth}','${inlineHeigth}','${width_scale}','${height_scale}')" href="javascript:void(0)"></a>
					</#if>
				</figcaption>
			</figure>
			<#if (position!'m')=='b'>
